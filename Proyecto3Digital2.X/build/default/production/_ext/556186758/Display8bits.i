# 1 "C:/MPlab_Digital2/Digital_2/Proyecto3Digital2.X/Display8bits.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/MPlab_Digital2/Digital_2/Proyecto3Digital2.X/Display8bits.c" 2
# 10 "C:/MPlab_Digital2/Digital_2/Proyecto3Digital2.X/Display8bits.c"
...
# 9 "C:/MPlab_Digital2/Digital_2/Proyecto3Digital2.X/Display8bits.h" 2
...
# 10 "C:/MPlab_Digital2/Digital_2/Proyecto3Digital2.X/Display8bits.c" 2
...
void Lcd_Cmd(char a){
 ...
 Lcd_Port(a);
 RE2 = 1;
    _delay((unsigned long)((10)*(400000/4000.0)));
    RE2 = 0;
}
void Lcd_Clear(void){
 Lcd_Cmd(1);
...
void Lcd_Init(void){
  _delay((unsigned long)((15)*(400000/4000.0)));
  Lcd_Port(0x00);
   _delay((unsigned long)((20)*(400000/4000.0)));
  Lcd_Cmd(0x30);
 _delay((unsigned long)((5)*(400000/4000.0)));
  Lcd_Cmd(0x30);
 _delay((unsigned long)((160)*(400000/4000000.0)));
  Lcd_Cmd(0x30);

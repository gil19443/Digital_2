...
# 2 "<built-in>" 2
# 1 "configuracionADC.c" 2


# 1 "./configuracionADC.h" 1
# 34 "./configuracionADC.h"
...
# 35 "./configuracionADC.h" 2

void configADC(uint8_t canal, uint8_t vel);
# 3 "configuracionADC.c" 2
